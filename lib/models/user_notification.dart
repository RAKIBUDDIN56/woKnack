class UserNotification {
  ...
  UserNotification({this.imageUrl, this.content, this.time});
}

List<UserNotification> notifications = [
  new UserNotification(
      imageUrl: 'assets/music.jpg',
      content: 'Music Club posted a new video',
      time: '3 hours ago'),
  new UserNotification(
      imageUrl: 'assets/remedy.jpg',
      content: 'Remedy Room posted a new video',
      time: '8 hours ago'),
  new UserNotification(
      imageUrl: 'assets/cooking.jpg',
      content: 'Cooking Hub posted a new video',
      time: '9 hours ago'),
  new UserNotification(
      imageUrl: 'assets/sewing.jpg',
      content: 'Reddit posted a new video',
      time: '22 hours ago'),
  new UserNotification(
      imageUrl: 'assets/swimming.jpg',
      content: 'Swimming Hub posted a new video',
      time: '1 day ago'),
  new UserNotification(
